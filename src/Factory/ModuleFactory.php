...
final class ModuleFactory extends ModelFactory
{
    ...
    {
        return [
            'enseignent' => EnseignentFactory::randomOrCreate(), // TODO add App\Entity\enseignent type manually
            'filiere' => FiliereFactory::randomOrCreate(), // TODO add App\Entity\filiere type manually
            'nom' => self::faker()->text(255),
            'semsetre' => SemestreFactory::randomOrCreate(), // TODO add App\Entity\semestre type manually
        ];
    }
